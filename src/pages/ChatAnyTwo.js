...
import '../styles/chatAnyTwo.scss';
import ChatModal from '../components/ChatModal';
import sendchat from '../assets/send chat.png';


export default function ChatAnyTwo(props) {
      ...
      <Grid className='gridGroup'>
          <Grid.Col span={4}>
              <div className='chat-background'>
                  ...
                  <ChatModal />
                  <div className='contact-person-1-background-2'>
                      <p className='contact-person-1-name'>Anonymous</p>
                  </div>
                  <div className='contact-person-2-background-2'>
                      <p className='contact-person-2-name'>Anonymous</p>
                  </div>
                  <div className='contact-person-3-background-2'>
